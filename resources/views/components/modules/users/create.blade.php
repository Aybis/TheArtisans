...
@section('content')
<div class="kt-portlet animated fadeInDown">
    <div class="kt-portlet__body kt-portlet__body--fit">
        <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
            ...
            <div class="kt-wizard-v3__nav">
                ...
                <div class="kt-wizard-v3__nav-items kt-wizard-v3__nav-items--clickable">
                    ...
                    <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step">
                        <span>3</span>
                        <i class="fa fa-check"></i>
                        <div class="kt-wizard-v3__nav-label">Employee Details</div>
                    </div>
                </div>
            </div>
            ...
            <form class="kt-form" id="kt_form">
                ...
                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                    ...
                    <div class="kt-form__section kt-form__section--first">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" placeholder="Enter username" value="mail">
                            <span class="form-text text-muted">Please enter your username</span>
                        </div>
                        <div class="form-group">
                            <label>Email address:</label>
                            <input type="email" class="form-control" name="email" placeholder="Enter email" value="mail@binmail.com">
                            <span class="form-text text-muted">We'll never share your email with anyone else</span>
                        </div>
                        {{-- <div class="form-group">
                            <label>Password:</label>
                            <input type="password" class="form-control" name="password" placeholder="Enter password" value="password">
                    ...
                    <div class="kt-form__section kt-form__section--first">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Contact:</label>
                                    <input type="text" class="form-control" name="phone" placeholder="Enter your phone number" value="1-555-777-3010">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Email:</label>
                                    <input type="text" class="form-control" name="email" placeholder="Enter your phone number" value="office@loop.com">
                                    <span class="form-text text-muted">Enter your email</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="address1" placeholder="" value="District 2 1657 Riverside Drive Redding 530-225-3426">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="address2" placeholder="" value="1657 Riverside Drive Redding">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="zip" placeholder="" value="96001">
                                </div>
                                <div class="form-group">
                                    <label>Country:</label>
                ...
                <!--begin:Step 3-->
                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content">
                    <div class="kt-heading kt-heading--md">Your Company Details</div>
                    <div class="kt-separator kt-separator--height-xs"></div>
                    <div class="kt-form__section kt-form__section--first">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="company_name" placeholder="Enter company name" value="ArtDigito Inc.">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="company_id" placeholder="Enter your company registered ID" value="FA6543213434">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="company_email" placeholder="Enter company email" value="clinets@artDigito.com">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="company_tel" placeholder="Enter comapny contact" value="1-333-666-3010">
...
@section('external_js')]
<script src="{{ asset('assets/js/pages/custom/users/add.js')}}" type="text/javascript"></script>
