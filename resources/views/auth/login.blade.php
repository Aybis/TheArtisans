					...
					<div class="kt-login-v2__body">
						...
						<div class="kt-login-v2__wrapper animated fadeInLeft">
							<div class="kt-login-v2__container">
								...
								<!--begin::Form-->
                                <form method="post" action="" class="kt-login-v2__form kt-form" autocomplete="off" id="kt_login_form">
                                <input type="hidden" id="_token" value="{{ csrf_token()}}">
									<div class="form-group">
                                        <input name="nik" id="username" type="text" class="form-control {{$errors->has('nik') ? 'is-invalid' : '' }}" placeholder="Username" value="{{ old('username') }}" required autofocus>
                                        @if ($errors->has('nik'))
